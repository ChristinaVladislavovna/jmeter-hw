...
WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "//a[@class='btn btn-white btn-sidebar sidebar_btn -profile']"))).click()
WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "//button[@class='btn btn-primary']"))).click()
# last_name = "Popova"
last_name = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "//input[@formcontrolname='lastName']")))
last_name.clear()
last_name.send_keys("Popova")
# WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//button[@class='btn btn-primary']"))).click()

assert "undefined" not in driver.title
