...
WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.CSS_SELECTOR, "button[appscrollto^='con']"))).click()


msg = 'support@ithillel.ua'
result = re.match(r'([\w]{7}@[\w]{8}.[\w]{2})', msg)
print(result)
